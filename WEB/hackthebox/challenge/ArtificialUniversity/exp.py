...
order_id="1"#fixit
pdfurl="https://github.com/noobctfer/vunlseek/blob/main/WEB/hackthebox/challenge/ArtificialUniversity/poc.pdf" #change to your pdf url,you can also use the pdf in github
